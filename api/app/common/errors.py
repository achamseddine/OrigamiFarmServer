...
class ErrorCode:
    ...
    # Retired, and kept only so a client that still branches on one of
    # these strings compiles. Nothing raises them: MODULE_NOT_ENTITLED
    # went with per-module entitlements, and the other four went with
    # device licences and tablet pairing.
